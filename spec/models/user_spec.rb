...
describe User do
  ...
  it "should reject usernames gt 50" do
    long_name = "a"*51
  ...
  describe "password validations" do
    ...
    it "should require password = password confirmation" do
      User.new(@attr.merge(:password_confirmation => "123abc")).should_not be_valid
    end
    it "should reject passwords lt 6" do
      short = "a" * 5
      User.new(@attr.merge(:password => short, :password_confirmation => short)).should_not be_valid
    end
    it "should reject password gt 40" do
      long = "a" * 41
    ...
    describe "password encryption" do
      ...
      describe "authenticate method" do
        ...
        it "should return nil for an email address with no user" do
          nonexistent_user = User.authenticate("me@go.com",@attr[:password])
